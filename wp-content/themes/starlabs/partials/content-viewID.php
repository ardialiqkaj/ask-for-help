...
<p class="text-gray-500 leading-8 mr-2 min-w-[60px] dark:text-white"><?= gt_get_post_views($post_ID); ?></p>
<?php } else { ?>
<p class="text-gray-500 leading-8 mr-2 min-w-[60px] dark:text-white">0 Views</p>
<?php }; ?>